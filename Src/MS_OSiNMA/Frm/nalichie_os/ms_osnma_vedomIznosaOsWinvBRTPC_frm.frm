.LinkForm 'ms_osnma_vedomIznosaOsWinvBRTPC_frm' Prototype is 'OSOPIS'
.Group 'Ведомости наличия ОС'
.NameInList 'Ведомость износа основных средств с инв.номерами БРТПЦ'
.p 60
.DEFO LANDSCAPE
.var
...
.fields
  ...
  DoubleToStr(Стоимость, ФорматСум)
  ...
  DoubleToStr(Итого_стоимость, ФорматСум)
...
 Ш────────────────────┬────────────────────┬───────────────────────────────────┬────────────────────────┬───────────┬────────────┬───────┬────────────────────┬────────────────────┬────────────────────┬────────────────────
                    │                    │                                   │    Амортизация         │           │            │       │                    │                    │                    │
 Инвентарный номер  │  Инв.номер БРТПЦ   │  Наименование основного средства  ├─────┬─────────┬────────┤   Дата    │    Дата    │Кол-во │     Стоимость      │@~@@@@@@@@@@@@@@@@@@│@~@@@@@@@@@@@@@@@@@@│     Остаточная
