...
(Для услуг индексации), не заполнен - услуга печатается как обычно.
  2) СчФакт_ПараметрИндексации {Строка} - расчетный параметр для того,  чтобы узнать расчетное значение
индексациии (Можно узнать, если щелкнуть ПКМ по услуге в спецификации ДО, выбрать
"Параметры расчетной услуги", поставить галочку "Печать пояснительного протокола").
